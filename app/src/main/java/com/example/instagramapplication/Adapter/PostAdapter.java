...
import com.example.instagramapplication.CommentActivity;
import com.example.instagramapplication.FollowersActivity;
import com.example.instagramapplication.Fragments.PostDetailFragment;
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(post.getPublisher()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try{
                    ...
                    System.out.println("Read post fail");
                }
